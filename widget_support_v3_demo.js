...
//    const activePlan           = vueRoot.company?.stripeActivePlan   ?? '';
    ...
    window.botpress.init({
      ...
      user: {
        data: {
          email:             "shuan@gohighlevel.com",
          agencyName:        "BAMFs Agency",
          locationId:        "loc_001",
          locationName:      "Robin's Computer Business",
          name:              "Shaun Clark",
          relationshipId:    "0-000-001",
          userPermissions:   "agency",
          userRole:          "admin",
          visitorId:         "sc_001",
          agencyWhiteLabelUrl:     "https://app.bamfs.com",
          agencyLocationCount:     "101",
          hipaaEnabled:      "true",
          activePlan:        "agency_monthly_497",
